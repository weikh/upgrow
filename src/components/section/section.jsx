      ...
      <div className="flex flex-col mt-[40px] ml-[40px]">
        ...
        <div className="flex justify-between gap-[30px] mt-[30px]">
          ...
          >
            ...
            <p className="max-w-[320px] mt-5 font-normal text-[16px] leading-[25px] text-[#5b5b5b]">
              {t("section-text5")}
            </p>
          </div>
          ...
          >
            ...
            <p className="max-w-[310px] mt-5 font-normal text-[16px] leading-[25px] text-[#5b5b5b]">
              {t("section-text7")}
            </p>
          </div>
        ...
        <div className="flex justify-between mt-[30px]">
          ...
          >
            ...
            <p className="max-w-[515px] mt-5 font-normal text-[16px] leading-[25px] text-[#5b5b5b]">
              {t("section-text11")}
            </p>
          </div>
