...
const Hero = () => {
  ...
  return (
    <div
      id="hero"
      className="max-w-[1280px] min-h-[536px] mx-auto pt-[110px] flex justify-between hero-bg rounded-tr-[20px] rounded-br-[20px]"
    >
      ...
      <div className="rounded-tr-[20px] rounded-br-[20px]">
